    ...
    <section className="grid gap-10 md:grid-cols-[1.3fr_1fr] md:items-center my-[50px] w-[80%] mx-auto">
      <div>
        ...
        <h1 className="mt-8 text-[40px] lg:text-[70px] font-bold leading-tight text-slate-900 ">
          Discover &amp; <br /> Share AI-  <br/>
           Generated Content
        </h1>
        <p className="mt-10 max-w-2xl text-lg text-slate-600">
          A modern hub for publishing, discovering, and exploring AI-assisted
          articles. Read what the future is writing and collaborate with
          creators pushing the frontier of intelligent storytelling.
        </p>
        <div className="mt-8 flex flex-wrap gap-4">
          <button className="flex items-center gap-2 rounded-2xl bg-[#2f6cff] px-6 py-3 text-sm font-semibold text-white shadow-[0_20px_50px_rgba(47,108,255,0.3)] transition hover:bg-[#1445d9]">
            Explore Posts
            <span aria-hidden="true">→</span>
          </button>
          <button className="rounded-2xl border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:text-slate-900">
            Start Writing
          </button>
        </div>
      </div>
